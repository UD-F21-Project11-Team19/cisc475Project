...
class _MyHomePageState extends State<MyHomePage> {
  // 地图的尺寸比例
  // The size ratio of the map
  List data;
  //final String url = "https://128.4.84.62:3000/addData/1/2/3/4";
  final double _sheetH = 250.0;
  ...
  Future<String> getData() async{
    var response = await http.get(
      Uri.encodeFull("http://128.4.84.62:3000/addData/"+ ((tapX * 100 / _mapW).ceil()).toString() + "/" + (((_mapH - tapY) * 100 / _mapH).ceil()).toString()),
      headers: {
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        left: tapX - 25,
                        child: Image.asset(
                          'assets/images/xiaoqiche.png', //car on map page
                          width: 50,
                          height: 50,
                        ),
                      )
